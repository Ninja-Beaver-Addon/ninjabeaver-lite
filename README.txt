...
Teams               => Fixed: Column border issue,social icon alignment issue in all layout,typography,Background color,Hover background color,border-radius options issue are fixed,layout type error solved.
